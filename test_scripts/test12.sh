...
echo "**************************************************************"
echo "Shell script to test if restore oldest of BKPFS works properly"
echo "=============================================================="
...
if ./bkpctl -r 2 -f sample.txt | grep --quiet "Restore Backup: Failure"; then
	echo "Test 01: ------------------------------------------------------------> Passed"
else
	echo "Test 01: ------------------------------------------------------------> Failed"
fi
...
if ./bkpctl -r 3 -f sample.txt | grep --quiet "Restore Backup: Success"; then
	echo "Test 01: ------------------------------------------------------------> Passed"
else
	echo "Test 01: ------------------------------------------------------------> Failed"
fi
